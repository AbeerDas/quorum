...
const (
	Raft_RequestVote_FullMethodName   = "/quorum.raft.v1.Raft/RequestVote"
	Raft_AppendEntries_FullMethodName = "/quorum.raft.v1.Raft/AppendEntries"
)
...
var Raft_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "quorum.raft.v1.Raft",
