...
const file_raft_raftpb_raft_proto_rawDesc = "" +
	"\n" +
	"\x16raft/raftpb/raft.proto\x12\x0equorum.raft.v1\"N\n" +
	"\bLogEntry\x12\x12\n" +
	...
	"\x04term\x18\x01 \x01(\x04R\x04term\x12!\n" +
	"\fvote_granted\x18\x02 \x01(\bR\vvoteGranted\"\xea\x01\n" +
...
var file_raft_raftpb_raft_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_raft_raftpb_raft_proto_goTypes = []any{
	(*LogEntry)(nil),              // 0: quorum.raft.v1.LogEntry
	(*RequestVoteRequest)(nil),    // 1: quorum.raft.v1.RequestVoteRequest
	(*RequestVoteResponse)(nil),   // 2: quorum.raft.v1.RequestVoteResponse
	(*AppendEntriesRequest)(nil),  // 3: quorum.raft.v1.AppendEntriesRequest
	(*AppendEntriesResponse)(nil), // 4: quorum.raft.v1.AppendEntriesResponse
}
var file_raft_raftpb_raft_proto_depIdxs = []int32{
	0, // 0: quorum.raft.v1.AppendEntriesRequest.entries:type_name -> quorum.raft.v1.LogEntry
	1, // 1: quorum.raft.v1.Raft.RequestVote:input_type -> quorum.raft.v1.RequestVoteRequest
	3, // 2: quorum.raft.v1.Raft.AppendEntries:input_type -> quorum.raft.v1.AppendEntriesRequest
	2, // 3: quorum.raft.v1.Raft.RequestVote:output_type -> quorum.raft.v1.RequestVoteResponse
	4, // 4: quorum.raft.v1.Raft.AppendEntries:output_type -> quorum.raft.v1.AppendEntriesResponse
