...
- [Stage 6 — one command, three machines, and a kill switch](stage-6-containers-and-controls.md) — containers, the fault controls, and why freezing a node meant stopping its clock
- [Stage 8 — measuring it for real](stage-8-benchmarks.md) — the actual performance numbers, and two settings that were wrong together
